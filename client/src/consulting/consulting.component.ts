...
@Component({
    selector: 'consulting-root',
    template: '<consulting-contact-us (onDataSaved)="handleOnDataSaved()"></consulting-contact-us>',
    styleUrls: []
})
...
export class ConsultingComponent {
    ...
    ngOnInit() {
        ...
        //     this.http.getPromise<mdCallResponse>(this.constants.EndPoints.GetAuthUser).then((res:mdCallResponse) => {
        //         this.log.debug(res);
        //         this.spinner.hide();
        //         if (res.isSuccess) {
        //             //a user is logged in
