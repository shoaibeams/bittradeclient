    ...
    return (
      <>
        <div className="gx-text-center">
          <img className="gx-mt-2 gx-mb-2"
            src="/assets/images/footer-logo.png"
            width={180}
            height={88}></img>
        </div>
        <div className="gx-login-container" style={{ overflow: 'auto', paddingBottom: '120px', height: 'unset' }}>
          <div className="gx-login-content gx-text-center" style={{ maxWidth: '500px' }}>
            <div className="gx-login-header">
              <h1 className="gx-login-title">{this.state.verificationEmailHeader}</h1>
            ...
            <p className="p-body color-white" style={{ fontSize: '18px' }}>{this.state.verificationEmailDetail}</p>
            <Button
