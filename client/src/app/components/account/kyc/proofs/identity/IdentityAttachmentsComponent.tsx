...
import { Card, Upload, Row, Col } from "antd";
import { StaticHelper } from "../../../../../../shared/static-helper";
import { mdFormControl } from "../../../../../../shared/form-control";
import Widget from "../../../../../../components/Widget";
import AttachmentComponent from "./AttachmentComponent";

export default class IdentityAttachmentsComponent extends BaseComponent {
  render() {
    this.initShorts();
    let docsRequired = 1;
    let headerStyle = {};
  ...
  init() {
    ...
    if (this.accountType == AccountTypes.Business) {
      this.identityDocuments = [
        ...
        DocumentTypesWithNames.MemorandumOfAssociation
      ];
      doc1.placeholder =
        DocumentTypesWithNames.BusinessIncorporationCertificate.title;
      doc2.placeholder = DocumentTypesWithNames.MemorandumOfAssociation.title;
    } else {
      this.identityDocuments = [
        DocumentTypesWithNames.Passport,
        DocumentTypesWithNames.NIC,
        DocumentTypesWithNames.ResidentPermit
      ];
      doc1.placeholder = DocumentTypesWithNames.Passport.title;
      doc2.placeholder = DocumentTypesWithNames.NIC.title;
      doc3.placeholder = DocumentTypesWithNames.ResidentPermit.title;
    }
    this.state = {
      form: {
        doc1,
