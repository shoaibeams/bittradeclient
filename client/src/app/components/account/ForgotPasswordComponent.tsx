...
export class ForgotPasswordComponent extends BaseComponent {
              ...
              this.state.emailSent ?
                ...
                <div>
                  <div className="gx-flex-row">
                    <span className="gx-mb-2 gx-mr-3">{this.lang.ForgotYourPasswordPara}</span>
                  </div>
  ...
  onSubmit = (e) => {
    ...
    this.http.post<mdCallResponse>(this.constants.EndPoints.PostAccountForgotPassword, formData)
